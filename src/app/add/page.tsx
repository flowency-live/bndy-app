    ...
    <Suspense>
      <div className="mx-auto max-w-5xl px-4 pt-2 lg:px-8">
        <div className="mb-3 flex justify-end gap-2">
          <Link href="/add/artist" className="inline-flex min-h-10 items-center gap-1.5 rounded-xl border border-line bg-card2 px-3 text-[11.5px] font-black text-dim transition-colors hover:text-txt">
            <Music2 size={13} className="text-[var(--acc)]" /> Add artist
          </Link>
          <Link href="/add/venue" className="inline-flex min-h-10 items-center gap-1.5 rounded-xl border border-line bg-card2 px-3 text-[11.5px] font-black text-dim transition-colors hover:text-txt">
