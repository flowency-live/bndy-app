  ...
  return (
    <div className="px-4 py-8">
      ...
      <div className="mx-auto mt-5 w-full max-w-sm rounded-2xl border border-[var(--acc)]/35 bg-[color-mix(in_srgb,var(--acc)_7%,transparent)] p-4">
        <div className="text-[12px] font-black text-txt">Do you manage an artist or venue?</div>
        <p className="mt-1 text-[11px] font-semibold leading-relaxed text-dim">This sign-in is your normal bndy account for favourites, filters and personal features. Use the same account to find, add or claim any artists and venues you manage.</p>
        <Link href="/join" className="mt-3 inline-flex min-h-9 items-center rounded-xl bg-acc px-3 text-[11px] font-black text-on-acc">Find or add an artist or venue →</Link>
      </div>
    </div>
  );
}
