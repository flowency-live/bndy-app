...
export function Avatar({
  ...
  const optimise = showImg && canUseNextImage(src!);
  return (
    <div
    ...
    >
      ...
      {showImg && !optimise && (
        ...
        <img src={src!} alt={name} loading="lazy" decoding="async" referrerPolicy="no-referrer" onError={() => setFailed(true)} className="absolute inset-0 h-full w-full object-cover" />
      )}
