...
export function FestivalRibbon({
  ...
  const inner = (
    <>
      ...
      <span className="min-w-0 flex-1">
        ...
        <span className={cn("block truncate font-black leading-tight", compact ? "text-[10.5px]" : "text-[12px]")}>{name}</span>
      </span>
  ...
  const classes = cn(
    "festival-ribbon flex min-w-0 items-center gap-2 overflow-hidden border",
